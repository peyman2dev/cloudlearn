...
export default function Hero() {
  return (
    <section className="mb-[100px] h-[80vh] pt-[100px] relative flex items-center justify-center gap-4 flex-col container">
      <div className="px-6 w-[90%]  mx-auto sm:w-full shadow-sm py-3 flex-wrap justify-start md:justify-center font-Worksans-Medium rounded-md bg-white dark:bg-dark-15 items-center flex gap-4">
